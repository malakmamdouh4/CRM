...
function demosList($id = null)
{
  $list = [
    ...
    [
      ...
      'data' => [
          'link' => getSettingValue('demoLink1'),
          'username' => getSettingValue('demoUserName1'),
          'password' => getSettingValue('demoPassword1')
      ]
    ],
    [
      'status' => 1 ,
      ...
      'data' => [
          'link' => getSettingValue('demoLink2'),
          'username' => getSettingValue('demoUserName2'),
          'password' => getSettingValue('demoPassword2')
      ]
    ],
    [
      'status' => 1 ,
      ...
      'data' => [
          'link' => getSettingValue('demoLink3'),
          'username' => getSettingValue('demoUserName3'),
          'password' => getSettingValue('demoPassword3')
      ]
      ],
