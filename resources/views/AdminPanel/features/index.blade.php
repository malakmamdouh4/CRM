                    ...
                    <div class="repeatableNewFeatures col-sm-12">
                            ...
                            @foreach($feature->featureArr() as $index => $feature)
                                <div class="More row">
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">{{trans('common.icon')}}</label>
                                        {{ Form::text('featuresIcon[]',$feature['icon'],array('id'=>'featuresIcon','class'=>'form-control')) }}
                                    </div>
                                    <div class="col-12 col-md-8">
                                        <label class="form-label">{{trans('common.title')}}</label>
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        {{ Form::textarea('featuresDescription[]',$feature['description'],array('id'=>'featuresDescription','class'=>'form-control','onkeyup'=>'updateTotals(this)')) }}
                                    </div>
                                    @if($index > 0)
                        ...
                        @else
                            <div class="More row">
                                ...
                                <div class="col-12 col-md-12">
                                    <label class="form-label">{{trans('common.description')}}</label>
                                    {{ Form::textarea('featuresDescription[]','',array('id'=>'featuresDescription','class'=>'form-control','onkeyup'=>'updateTotals(this)')) }}
                                </div>
                            </div>
                        @endif
                    </div>
                    <div class="col-12">
                        <span class="add_NewFeature btn btn-sm btn-info"> {{trans('common.addnew')}}</span>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['files'=>'true','url'=>route('admin.features.store'), 'id'=>'createFeatureForm', 'class'=>'row gy-1 pt-75'])}}
                        ...
                        <div class="col-12">
                            <span class="add_Feature btn btn-sm btn-info">{{trans('common.addnew')}} </span>
                        </div>
